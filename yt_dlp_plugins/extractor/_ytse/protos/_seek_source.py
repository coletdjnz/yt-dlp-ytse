...
class SeekSource(protobug.Enum, strict=False):
    ...
    SEEK_SOURCE_SABR_SEEK_TO_START = 16  # deprecated?
    ...
    # Proto mapping below not confirmed
    SEEK_SOURCE_SEEK_TO_END_OF_LOOPING_RANGE_OF_SHORTS = 60
    SEEK_SOURCE_CLIP_SLIDE_ON_FILMSTRIP = 61
    ...
    SEEK_SOURCE_LR_MEDIA_SESSION_SEEK = 85
    SEEK_SOURCE_MIDROLLS_WITH_TIME_RANGE = 86
    SEEK_SOURCE_SKIP_AD = 87
    SEEK_SOURCE_SEEK_TO_PREVIOUS = 88
    SEEK_SOURCE_SEEK_TO_NEXT = 89
    SEEK_SOURCE_LR_QUICK_SEEK = 90
    SEEK_SOURCE_ONESIE_LIVE = 91
    SEEK_SOURCE_LR_PLAYER_CONTROL_ACTION = 92
    SEEK_SOURCE_UNPLUGGED_LENS_START_CLIP = 93
    SEEK_SOURCE_LR_KEY_PLAYS = 94
    SEEK_SOURCE_SSAP_AD_FMT_FATAL = 95
    SEEK_SOURCE_TVHTML5_INPUT_SOURCE_KEY_EVENT = 96
    SEEK_SOURCE_TVHTML5_INPUT_SOURCE_CONTROLS = 97
    SEEK_SOURCE_TVHTML5_INPUT_SOURCE_TOUCH = 98
    SEEK_SOURCE_TVHTML5_INPUT_SOURCE_TOUCHPAD = 99
    SEEK_SOURCE_SEEK_TO_HEAD = 100
    SEEK_SOURCE_AUTOMATIC_PREVIEW_REPLAY_ACTION = 101
    SEEK_SOURCE_H5_MEDIA_ELEMENT_EVENT = 102
    SEEK_SOURCE_H5_WORKAROUND_SEEK = 103
    SEEK_SOURCE_MINIPLAYER_REWIND_BUTTON = 104
    SEEK_SOURCE_MINIPLAYER_FAST_FORWARD_BUTTON = 105
    SEEK_SOURCE_SABR_RELOAD_PLAYER_RESPONSE_TOKEN_SEEK = 106
    SEEK_SOURCE_SLIDE_ON_SCRUBBER_BAR_CHAPTER = 107
    SEEK_SOURCE_ANDROID_CLEAR_BUFFER = 108