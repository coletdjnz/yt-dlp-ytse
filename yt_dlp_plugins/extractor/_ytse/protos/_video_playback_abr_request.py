...
class VideoPlaybackAbrRequest:
    client_abr_state: typing.Optional[ClientAbrState] = protobug.field(1)
    selected_format_ids: list[FormatId] = protobug.field(2)
    buffered_ranges: list[BufferedRange] = protobug.field(3)
    video_playback_ustreamer_config: typing.Optional[protobug.Bytes] = protobug.field(5)
    lo: Lo = protobug.field(6)
    selected_audio_format_ids: list[FormatId] = protobug.field(16)
    selected_video_format_ids: list[FormatId] = protobug.field(17)
    streamer_context: StreamerContext = protobug.field(19)
    field21: OQa = protobug.field(21)
    field22: typing.Optional[protobug.Int32] = protobug.field(22)
    field23: typing.Optional[protobug.Int32] = protobug.field(23)
    field1000: list[Pqa] = protobug.field(1000)